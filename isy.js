...
class ISY {
    ...
    getDeviceTypeBasedOnISYTable(deviceNode) {
        ...
        this.logger(" got device familyId: " + familyId + " mainType: " + mainType + " subType: " + subType + " subAddress: " + subAddress);
    ...
    loadDevices(result) {
        ...
        doc.parseString(result,(err,obj) => {
            ...
            if(!(this.deviceMap.has(device.pnode)))
            {
                ...
                this.deviceMap[device.pnode] = {address};
            }
            else
            {
            ...
            if (enabled !== 'false') {
                ...
                if (deviceTypeInfo != null) {
                    if (deviceTypeInfo.deviceType == this.DEVICE_TYPE_DIMMABLE_LIGHT ||
                        ...
                        newDevice = new ISYLeakDevice(this, device, deviceTypeInfo);
                    }
