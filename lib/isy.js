...
class ISY {
    ...
    async callISY(url) {
        ...
        return utils_1.getAsync(url, this.restlerOptions);
    }
        ...
        for (const device of obj.nodes.node) {
            ...
            if (enabled !== 'false') {
                ...
                if (deviceTypeInfo !== null && deviceTypeInfo !== undefined) {
                    ...
                    else if (deviceTypeInfo.deviceType === isyconstants_1.DeviceTypes.lock || deviceTypeInfo.deviceType === isyconstants_1.DeviceTypes.secureLock) {
    ...
    loadElkNodes(result) {
        ...
        for (let index = 0; index < nodes.length; index++) {
            ...
            const newDevice = new elkdevice_1.ElkAlarmSensorDevice(this, name, 1, id, alarmDef === 17 ? isyconstants_1.DeviceTypes.alarmDoorWindowSensor : isyconstants_1.DeviceTypes.coSensor);
