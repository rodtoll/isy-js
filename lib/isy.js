...
const parser = new xml2js_1.Parser({
    explicitArray: false,
    mergeAttrs: true,
    valueProcessors: [xml2js_1.parseNumbers, xml2js_1.parseBooleans],
    attrValueProcessors: [xml2js_1.parseNumbers, xml2js_1.parseBooleans]
});
exports.Controls = {};
    ...
    constructor(address, username, password, elkEnabled, changeCallback, useHttps, scenesInDeviceList, enableDebugLogging, variableCallback, log) {
        ...
        this.restlerOptions = {
            ...
            xml2js: {
                explicitArray: false,
                mergeAttrs: true,
                attrValueProcessors: [xml2js_1.parseBooleans, xml2js_1.parseNumbers],
                valueProcessors: [xml2js_1.parseNumbers, xml2js_1.parseBooleans]
            }
        };
        // this.deviceMap = new Map();
