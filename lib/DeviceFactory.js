...
class DeviceFactory {
    static createDevice(nodeDef) {
        ...
        if (nodeDefId === 'KeypadButton' || nodeDefId === 'KeypadButton_ADV') {
            str.class = InsteonKeypadDevice_1.InsteonKeypadButtonDevice;
        }
        if (str.class === InsteonOnOffOutletDevice_1.InsteonOnOffOutletDevice && nodeDef.address.split(' ')[3] === '2') {
            str.class = InsteonRelayDevice_1.InsteonRelayDevice;
        }
        return str;
    }
    ...
    static getInsteonDeviceDetails(typeCode) {
        ...
        str.version = type.firmwareVersion;
    ...
    static getNLSSwitchLightInfo(device) {
        ...
        switch (c) {
            ...
            case String.fromCharCode(0o021):
                ...
                break;
            case String.fromCharCode(0o017):
                retVal = { name: 'KeypadLinc Relay', modelNumber: '2486S/WH6', class: InsteonDimmerKeypadDevice_1.InsteonKeypadRelayDevice };
                break;
            case String.fromCharCode(0o005):
                retVal = { name: 'KeypadLinc Relay (8 buttons)', modelNumber: '2486S/WH8', class: InsteonDimmerKeypadDevice_1.InsteonKeypadRelayDevice };
                break;
            ...
            case String.fromCharCode(0o034):
                ...
                break;
            case '%':
                retVal = { name: 'KeypadLinc Timer Relay (8 buttons)', modelNumber: '2484S/WH8', class: InsteonDimmerKeypadDevice_1.InsteonKeypadRelayDevice };
                break;
            case ' ':
                retVal = { name: 'KeypadLinc Relay', modelNumber: '2486S/WH6-SP', class: InsteonDimmerKeypadDevice_1.InsteonKeypadRelayDevice };
                break;
            case '!':
            ...
            case String.fromCharCode(0o036):
                break;
            case ',':
                retVal = { name: 'Dual Band KeypadLinc Relay', modelNumber: '2487S', class: InsteonDimmerKeypadDevice_1.InsteonKeypadRelayDevice };
                break;
    ...
    static getNLSDimLightInfo(device) {
        ...
        switch (c) {
            ...
            case '\r':
                ...
                break;
            case '\f':
                retVal = { name: 'KeypadLinc Dimmer 8 Button', modelNumber: '2486DWH8', class: InsteonDimmerKeypadDevice_1.InsteonKeypadDimmerDevice };
                break;
            case String.fromCharCode(0o023):
            ...
            case String.fromCharCode(0o033):
                retVal = { name: 'KeypadLinc Dimmer 6 Buttons', modelNumber: '2486D', class: InsteonDimmerKeypadDevice_1.InsteonKeypadDimmerDevice };
                break;
            case String.fromCharCode(0o034):
                retVal = { name: 'KeypadLinc Dimmer 8 Buttons', modelNumber: '2486D', class: InsteonDimmerKeypadDevice_1.InsteonKeypadDimmerDevice };
                break;
            case String.fromCharCode(0o031):
            ...
            case 'T':
                ...
                break;
            case 'B':
                retVal = { name: 'KeypadLinc Dimmer 5 Buttons', modelNumber: '2334-2', class: InsteonDimmerKeypadDevice_1.InsteonKeypadDimmerDevice };
                break;
            case 'A':
                retVal = { name: 'KeypadLinc Dimmer 8 Buttons', modelNumber: '2334-2', class: InsteonDimmerKeypadDevice_1.InsteonKeypadDimmerDevice };
                break;
            case 'V':
                retVal = { name: 'KeypadLinc Dimmer 6 Buttons', modelNumber: '2334-632', class: InsteonDimmerKeypadDevice_1.InsteonKeypadDimmerDevice };
                break;
            case String.fromCharCode(0o013):
