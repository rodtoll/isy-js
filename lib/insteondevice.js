...
exports.KeypadDevice = (InsteonBaseDevice) => {
    return class extends InsteonBaseDevice {
        constructor(isy, node) {
            super(isy, node);
        }
...
class InsteonDimmerSwitchDevice extends exports.InsteonSwitchDevice(InsteonDimmableDevice) {
    constructor(isy, deviceNode) {
        super(isy, deviceNode);
    }
}
exports.InsteonDimmerSwitchDevice = InsteonDimmerSwitchDevice;
class InsteonKeypadDevice extends exports.KeypadDevice(InsteonRelayDevice) {
    constructor(isy, deviceNode) {
        super(isy, deviceNode);
    }
}
exports.InsteonKeypadDevice = InsteonKeypadDevice;
class InsteonDimmerKeypadDevice extends exports.KeypadDevice(InsteonDimmableDevice) {
    constructor(isy, deviceNode) {
        super(isy, deviceNode);
    }
}
...
class InsteonLeakSensorDevice extends isydevice_1.ISYBinaryStateDevice(InsteonBaseDevice) {
    constructor(isy, deviceNode) {
        super(isy, deviceNode);
    }
    get leakDetected() {
...
class InsteonCOSensorDevice extends isydevice_1.ISYBinaryStateDevice(InsteonBaseDevice) {
    constructor(isy, deviceNode) {
        super(isy, deviceNode);
    }
...
class InsteonSmokeSensorDevice extends isydevice_1.ISYBinaryStateDevice(InsteonBaseDevice) {
    constructor(isy, deviceNode) {
        super(isy, deviceNode);
    }
    get monoxideDetected() {
