...
exports.ElkAlarmSensor = exports.ELKAlarmPanelDevice = undefined;
...
ELKAlarmPanelDevice.prototype.sendSetAlarmModeCommand = function (alarmState, handleResult) {
	if (alarmState == _isy.ISY_COMMAND_ELK_ALARM_MODE_DISARMED) {
...
const _ELKAlarmPanelDevice = ELKAlarmPanelDevice;
exports.ELKAlarmPanelDevice = _ELKAlarmPanelDevice;

const _ElkAlarmSensor = ElkAlarmSensor;
exports.ElkAlarmSensor = _ElkAlarmSensor;