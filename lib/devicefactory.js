...
class DeviceFactory {
    static createDevice(nodeDef) {
        ...
        if (nodeDefId === 'FanLincMotor') {
            str.class = typeof InsteonFanDevice_1.InsteonFanMotorDevice;
        }
        return str;
    }
    static getDeviceDetails(family, typeCode) {
        if ((family !== null && family !== void 0 ? family : isy_1.Families.Insteon === isyconstants_1.default.Families.Insteon)) {
