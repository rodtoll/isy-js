...
class ELKAlarmPanelDevice extends ISYDevice_1.ISYDevice {
    constructor(isy, area) {
        super(isy, { family: Families_1.Family.Elk, type: '0.0.0.0', enabled: true, address: 'ElkAlarmPanel' + area, name: 'Elk Alarm Panel ' + area });
        this.area = area;
        ...
        if (areaId == this.area) {
            if (updateType == AlarmPanelProperty.AlarmTripState) {
                if (this.alarmTripState != valueToSet) {
                    ...
                    (_a = this.propertyChanged) === null || _a === void 0 ? void 0 : _a.emit('', 'alarmTripState', valueToSet);
                    valueChanged = true;
                }
            }
                ...
                if (this.alarmState != valueToSet) {
                    ...
                    (_b = this.propertyChanged) === null || _b === void 0 ? void 0 : _b.emit('', 'alarmState', valueToSet);
                    valueChanged = true;
                }
            }
                ...
                if (this.alarmMode != valueToSet) {
                    ...
                    (_c = this.propertyChanged) === null || _c === void 0 ? void 0 : _c.emit('', 'alarmMode', valueToSet);
                    valueChanged = true;
                }
            }
        }
...
class ElkAlarmSensorDevice extends ISYDevice_1.ISYDevice {
    constructor(isy, name, area, zone) {
        super(isy, { family: Families_1.Family.Elk, name, address: `ElkZone${zone}`, enabled: true });
        this.area = area;
        this.zone = zone;
        // this.name = name;
        ...
        if (zone == this.zone) {
            if (updateType == 51) {
                if (this.logicalState != valueToSet) {
                    ...
                    (_a = this.propertyChanged) === null || _a === void 0 ? void 0 : _a.emit('', 'logicalState', valueToSet);
                ...
                if (this.physicalState != valueToSet) {
                    ...
                    (_b = this.propertyChanged) === null || _b === void 0 ? void 0 : _b.emit('', 'physicalState', valueToSet);
                    valueChanged = true;
                }
            }
                ...
                if (this.voltage != valueToSet) {
                    ...
                    (_c = this.propertyChanged) === null || _c === void 0 ? void 0 : _c.emit('', 'voltage', valueToSet);
                    valueChanged = true;
                }
            }
        }
