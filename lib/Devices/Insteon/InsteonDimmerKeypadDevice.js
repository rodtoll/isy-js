...
class InsteonSwitchKeypadDevice extends InsteonDevice_1.KeypadDevice(InsteonRelayDevice_1.InsteonRelayDevice) {
    constructor(isy, deviceNode) {
        super(isy, deviceNode);
    }
}
exports.InsteonSwitchKeypadDevice = InsteonSwitchKeypadDevice;
