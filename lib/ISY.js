...
exports.InsteonKeypadRelayDevice = InsteonDimmerKeypadDevice_1.InsteonKeypadRelayDevice;
exports.InsteonKeypadDimmerDevice = InsteonDimmerKeypadDevice_1.InsteonKeypadDimmerDevice;
const InsteonLeakSensorDevice_1 = require("./Devices/Insteon/InsteonLeakSensorDevice");
exports.InsteonLeakSensorDevice = InsteonLeakSensorDevice_1.InsteonLeakSensorDevice;
...
exports.VariableType = ISYConstants_1.VariableType;
...
exports.InsteonOnOffOutletDevice = InsteonOnOffOutletDevice_1.InsteonOnOffOutletDevice;
const InsteonSmokeSensorDevice_1 = require("./Devices/Insteon/InsteonSmokeSensorDevice");
exports.InsteonSmokeSensorDevice = InsteonSmokeSensorDevice_1.InsteonSmokeSensorDevice;
const InsteonDimmerOutletDevice_1 = require("./Devices/Insteon/InsteonDimmerOutletDevice");
exports.InsteonDimmerOutletDevice = InsteonDimmerOutletDevice_1.InsteonDimmerOutletDevice;
const InsteonKeypadDevice_1 = require("./Devices/Insteon/InsteonKeypadDevice");
exports.InsteonKeypadButtonDevice = InsteonKeypadDevice_1.InsteonKeypadButtonDevice;
...
class ISY {
    constructor(config, logger) {
        ...
        this.debugLogEnabled = (_b = config.debugLogEnabled, (_b !== null && _b !== void 0 ? _b : false));
    ...
    loadElkNodes(result) {
        ...
        for (let index = 0; index < nodes.length; index++) {
            ...
            const newDevice = new ElkAlarmPanelDevice_1.ElkAlarmSensorDevice(this, name, 1, id /*TODO: Handle CO Sensor vs. Door/Window Sensor */);
    ...
    handleWebSocketMessage(event) {
        ...
        parser.parseString(event.data, (err, res) => {
            ...
            switch (stringControl) {
                case Families_1.EventType.Elk.toString():
                    if (actionValue === 2) {
                    ...
                    break;
                case Families_1.EventType.Trigger.toString():
                    if (actionValue === 6) {
                    ...
                    break;
                case Families_1.EventType.Heartbeat.toString():
                    this.logger(`Received ${Families_1.EventType[Number(stringControl)]} Signal from ISY: ${JSON.stringify(evt)}`);
                    break;
                default:
                    if (evt.node !== '' && evt.node !== undefined && evt.node !== null) {
                        ...
                        if (impactedDevice !== undefined && impactedDevice !== null) {
                            ...
                            this.logger(Families_1.EventType[Number(stringControl)] + ' Event for Unidentified Device: ' + JSON.stringify(evt));
                        }
                    }
                    else {
                        this.logger(`Unhandled ${Families_1.EventType[Number(stringControl)]} Event: ${JSON.stringify(evt)}`);
                    }
                    break;
            }
        });
